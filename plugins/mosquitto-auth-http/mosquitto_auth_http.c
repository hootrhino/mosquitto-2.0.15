...
int mosquitto_auth_http_version(void)
{
  return MOSQ_AUTH_PLUGIN_VERSION;
}

int mosquitto_auth_http_init(void **user_data, struct mosquitto_auth_opt *auth_opts, int auth_opt_count)
{
  UNUSED(user_data);
  int i = 0;
...
int mosquitto_auth_http_cleanup(void *user_data, struct mosquitto_auth_opt *auth_opts, int auth_opt_count)
{
  UNUSED(user_data);
  UNUSED(auth_opts);
...
int mosquitto_auth_http_security_init(void *user_data, struct mosquitto_auth_opt *auth_opts,
...
int mosquitto_auth_http_security_cleanup(void *user_data, struct mosquitto_auth_opt *auth_opts,
                                                int auth_opt_count, bool reload)
{
  UNUSED(user_data);
  UNUSED(auth_opts);
...
int mosquitto_auth_http_acl_check(void *user_data, const char *clientid,
                                         const char *username, const char *topic, int access)
{
  UNUSED(user_data);
